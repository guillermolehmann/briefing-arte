# Cómo vender arte moderno y contemporáneo en Nueva York
## Curso intensivo de Virginia — dictado por "Arte a la Mañana"

Curso de 4 semanas con UNA entrega por día, todos los días de la semana, en
secuencia estricta: cinco lecciones nuevas (L1 a L5), después un repaso corto
(R) y después una simulación práctica de conversación con un cliente (P), que
cierra la semana con el cuaderno escrito. No importa qué día del calendario
sea: se dicta siempre la entrega que sigue.

**Arranque: sábado 8 de agosto de 2026 con S01-L1. Una entrega por día, sin
saltear: termina el viernes 4 de septiembre con S04-P.** El progreso se
registra en memoria/programa.md con el código de la última entrega dictada
(ej. "S02-L3").

Regla de dictado: cada lección se cuenta en 3 a 5 minutos, con nombres, obras,
fechas y precios reales, verificados en la web al momento de dictar, no de
memoria. Cerrar siempre con "esto te sirve con un cliente cuando..." — la teoría
aterriza en la venta. Si la lección toca la agenda del día (una muestra, una
subasta), conectarla. Si existe un dossier en curso/fuentes/ para el tema,
leerlo antes de escribir.

---

## SEMANA 1 — El tablero de Nueva York

- S01-L1 El ecosistema: subastas, galerías, ferias, museos, advisors — cómo circula una obra y dónde está parada Virginia (Phillips) en ese circuito.
- S01-L2 Las tres casas: Christie's, Sotheby's, Phillips — qué vende cada una, tamaño, y cómo se diferencia Phillips (foco s. XX/XXI, apuesta joven, Editions).
...
- S02-L1 Los modernos que aparecen en consignaciones: Picasso y Matisse como pilares, y el surrealismo con puente latinoamericano — Kahlo, Carrington, Varo y el fenómeno de sus precios.
- S02-L2 Nueva York toma el poder: expresionismo abstracto (Pollock, Rothko, de Kooning), el pop de Warhol como mercado en sí mismo, y Basquiat como ícono de los coleccionistas nuevos.
...
- S03-L1 Saber mirar: medios y técnicas, jerarquía de precios dentro de un mismo artista (óleo vs papel vs edición), y qué mira un condition report.
- S03-L2 Procedencia y autenticidad: por qué la historia de propiedad hace el precio, catálogos razonados, y cómo leer una ficha de catálogo como profesional.
...
- S04-L1 Tipologías de coleccionista (apasionado, decorador, inversor, social) y el coleccionista latinoamericano de cerca: familia, ciudades, la confianza en el idioma propio.
- S04-L2 Descubrir: las preguntas que abren a un cliente sin que parezca interrogatorio, y el sistema para pasar de contacto a relación (frecuencia, contenido de valor, memoria de los detalles).
...
Terminadas las 4 semanas, la cápsula vuelve a ser libre, pero con una regla
nueva: una vez por semana retoma un tema del curso y lo profundiza con la
actualidad (un récord nuevo, una muestra, una venta), citando la lección
original.
